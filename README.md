# Node.js web app sign-up, sign-in, and sign-out with Azure Active Directory B2C
...
Please [look at this document](https://docs.microsoft.com/en-us/azure/active-directory/develop/active-directory-protocols-openid-connect-code) to understand OpenID Connect in the context of Azure Active Directory. 
